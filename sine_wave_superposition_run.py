...
# ______ / Command line arguments start here

parser = argparse.ArgumentParser(
    formatter_class=argparse.RawTextHelpFormatter,
    description='Model two traveling sine waves by definition of the General form y(t) = Asin(ωt) \n'
...
parser.add_argument('wa1', help='Wave 1 - Amplitude in mm', type=float)
parser.add_argument('wf1', help='Wave 1 - Frequency in Hz', type=float)
parser.add_argument('wa2', help='Wave 2 - Amplitude in mm', type=float)
parser.add_argument('wf2', help='Wave 2 - Frequency in Hz', type=float)
parser.add_argument('-ipw1', help='Wave 1 - Inverts wave polarity', action='store_true', default=False)
...
plot_wave_superposition(args.wa1, args.wf1, args.wa2, args.wf2, args.ipw1, args.ipw2)
